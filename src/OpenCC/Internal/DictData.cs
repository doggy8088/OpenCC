...
internal static partial class DictData
{
  ...
  [
    ""屏幕"",
    ""螢幕";
    public const string TWPhrasesCustomRev = @"一觸即發"",
    ""一觸即髮""
  ],
  [
    ""千鈞一髮"",
